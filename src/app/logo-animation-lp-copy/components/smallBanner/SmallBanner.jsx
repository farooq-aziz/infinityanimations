                    ...
                    <div className="grid grid-cols-1">
                        <div className="txt">
                            ...
                            <div className="btn group px-[15px] pt-[1%]">
                                <Link href="javascript:;" className='text-[17px] font-bold poppins group-hover:text-white text-[#f5090b] border-[#f5090b] border-2 rounded-[5px] leading-[19px] mt-[20px] py-[10px] px-[35px] w-full sm:w-[50%] lg:w-[20%] mx-auto text-center duration-700 group-hover:duration-700 ease-in-out group-hover:bg-[#f5090b] flex items-center justify-center overflow-hidden relative'>

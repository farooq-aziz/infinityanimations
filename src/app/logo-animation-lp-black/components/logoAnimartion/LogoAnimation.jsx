                        ...
                        <div className="grid grid-cols-3 gap-7 mt-[40px]">
                            <div>
                                <div className="card_1 flex gap-x-2 group">
                                    ...
                                    <div>
                                        <h4 className='text-[17px] font-[500] poppins pb-[15px] duration-700 group-hover:duration-700 ease-in-out group-hover:text-primary-100'>Unique Design Guarantee</h4>
                                        <p className='mb-0 leading-[22px] text-[15px] poppins text-justify'>We undergo the creative mindset with our creative graphic designers to produce dynamic animated logos. We create logo animations from the sketch that always revolves around customer-centric value.</p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div className="card_2 flex gap-x-2 group">
                                    ...
                                    <div>
                                        <h4 className='text-[17px] font-[500] poppins pb-[15px] duration-700 group-hover:duration-700 ease-in-out group-hover:text-primary-100'>
                                            Industry Specific Designers
                                        </h4>
                                        <p className='mb-0 leading-[22px] text-[15px] poppins text-justify'>We have a team of Industry-specific designers and logo animators with rich field experience that voice out the brand’s core values smartly in one go.</p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div className="card_3 flex gap-x-2 group">
                                    ...
                                    <div>
                                        ...
                                        <p className='mb-0 leading-[22px] text-[15px] poppins text-justify'>

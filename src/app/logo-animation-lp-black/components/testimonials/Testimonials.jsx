                ...
                <div className="px-4 sm:px-8 lg:max-w-7xl mx-auto overflow-hidden">
                    <div className="grid grid-cols-1">
                        <div className="txt pt-[3px]">
                            <h2 className="text-[#f5090b] text-[25px] md:text-[45px] font-[700] mb-[10px] sm:mb-[17px] text-center leading-[30px] font-sans relative before:absolute before:content-[''] before:top-[-20px] before:left-0 before:right-[35px] before:mx-auto before:h-[7px] before:w-[60px] before:bg-[#f5090b] uppercase">
                                Testimonials
                            </h2>
                            <div className="reviews flex items-center justify-center gap-2">
                                <FaStar className="text-[#f5090b] text-[24px]" />
                                <FaStar className="text-[#f5090b] text-[24px]" />
                                <FaStar className="text-[#f5090b] text-[24px]" />
                                <FaStar className="text-[#f5090b] text-[24px]" />
                                <FaStar className="text-[#f5090b] text-[24px]" />
                            </div>
                            <p className=' text-[20px] sm:text-[25px] lg:text-[32px] font-sans text-center uppercase leading-[25px] sm:leading-[30px] mt-[2%]'>...RATED 4.5 BY 8503 CUSTOMERS GLOBALLY</p>
                        </div>

            ...
            <section className='py-[30px] md:py-[60px]'>
                <div className="px-4 sm:px-8 lg:max-w-7xl mx-auto">
                    <div className="grid grid-cols-1">
                        <div className="txt">
                            <h2 className="text-[#00ce7d] text-[25px] md:text-[40px] font-[600] mb-0 text-center leading-[30px] font-sans relative before:absolute before:content-[''] before:top-[-20px] before:left-0 before:right-[35px] before:mx-auto before:h-[8px] before:w-[70px] before:bg-[#00ce7d]">WHY LOGO ANIMATION?</h2>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-3 gap-7 mt-[40px]">
                            <div>
                                <div className="card_1 flex gap-x-2 group">
                                    ...
                                    <div>
                                        <h4 className='text-[17px] font-[500] poppins pb-[15px] text-[#676a6b] duration-700 group-hover:duration-700 ease-in-out group-hover:text-[#00ce7d]'>Unique Design Guarantee</h4>
                            ...
                            <div>
                                <div className="card_2 flex gap-x-2 group">
                                    ...
                                    <div>
                                        <h4 className='text-[17px] font-[500] poppins pb-[15px] text-[#676a6b] duration-700 group-hover:duration-700 ease-in-out group-hover:text-[#00ce7d]'>
